...
- Previous versions:  
  - [`docs/IDTO_Concept_Public_Draft_V4.6.md`](docs/IDTO_Concept_Public_Draft_V4.6.md)  
  - [`docs/IDTO_Concept_Public_Draft_V4.5.md`](docs/IDTO_Concept_Public_Draft_V4.5.md)
...
Operational choices and implementation details are intentionally open for discussion (see **Chapter 8: Future Challenges (RFC)**).
...
- Update playbook: [`UPDATE_PLAYBOOK.md`](UPDATE_PLAYBOOK.md)
