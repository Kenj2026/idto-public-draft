...
- Versioned file (stable citation): [`docs/IDTO_Concept_Public_Draft_V5.0.md`](docs/IDTO_Concept_Public_Draft_V5.0.md)
- Previous versions: [`docs/IDTO_Concept_Public_Draft_V4.6.md`](docs/IDTO_Concept_Public_Draft_V4.6.md), [`docs/IDTO_Concept_Public_Draft_V4.5.md`](docs/IDTO_Concept_Public_Draft_V4.5.md)

For stable citation, cite the **versioned file** and/or a GitHub **Release tag**, rather than the “latest” pointer.

**Operational note:** `docs/IDTO_public_draft_latest.md` should remain a pointer (not a duplicated full text). The single source of truth for the full draft is the versioned file.
...
You may translate and reuse the text with attribution and change indication (see [`LICENSE`](LICENSE)).
